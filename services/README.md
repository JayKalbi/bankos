...
## Purpose
Contains all domain-driven microservices (Credit Risk, Payments, Fraud, etc.). Each service is independently deployable and autonomous.

## Responsibilities
- Encapsulate all logic and definitions related to the services domain.
