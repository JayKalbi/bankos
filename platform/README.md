...
## Purpose
Contains Platform Engineering utilities, golden path templates, developer CLI tools, and Backstage integration configs.

## Responsibilities
- Encapsulate all logic and definitions related to the platform domain.
