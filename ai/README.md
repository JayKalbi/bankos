...
## Purpose
Contains the Enterprise Artificial Intelligence Platform resources, including agents, prompts, evaluation datasets, and RAG architectures.

## Responsibilities
- Encapsulate all logic and definitions related to the ai domain.
