...
## Purpose
Contains web applications including the Executive Dashboard and customer-facing portals.

## Responsibilities
- Encapsulate all logic and definitions related to the frontend domain.
